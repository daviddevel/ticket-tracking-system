...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::get('users', [Api\AuthController::class, 'users']);
    
    Route::get('tickets', [Api\TicketController::class, 'Index']);
    Route::prefix('ticket')->group(function () {
        Route::post('store', [Api\TicketController::class, 'store']);
        Route::put('/{id}', [Api\TicketController::class, 'update']);
        Route::delete('/{id}', [Api\TicketController::class, 'destroy']);
    });
});
